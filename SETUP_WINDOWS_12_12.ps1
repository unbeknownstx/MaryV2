...
Write-Host "MARYV2 12.12 WINDOWS SETUP + VERIFICATION" -ForegroundColor Magenta
Write-Host "============================================================" -ForegroundColor Magenta
...
Step 4 "12.12 Cognitive Reservoir / character regressions"
& $Python -m pytest `
...
if ($LASTEXITCODE -ne 0) { throw "12.12 targeted regression suite failed." }
Pass "12.12 regressions"

Step 5 "12.12 deterministic verifier"
...
Write-Host "MARYV2 12.12 READY" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
