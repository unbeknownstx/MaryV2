...
def main()->int:
    ...
    check("12.8 ecosystem remains present under current release",APP_VERSION in {"12.8.0", "12.9.0"} and DESKTOP_PHASE in {"ecosystem-presence-beta", "desktop-uplift-runtime"})
    required=(
