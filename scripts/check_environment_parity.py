...
def snapshot() -> dict[str, Any]:
    ...
    return {
        ...
        "routing": {
            ...
            "frontier_order": list(getattr(llm, "frontier_provider_order", []) or []),
            "expert_provider": getattr(llm, "expert_provider", ""),
        ...
        "models": {
            ...
            "deepseek": _env("MARY_DEEPSEEK_MODEL"),
            "zai": _env("MARY_ZAI_MODEL"),
            "qwen_cloud": _env("MARY_QWEN_CLOUD_MODEL"),
            "kimi": _env("MARY_KIMI_MODEL"),
            "minimax": _env("MARY_MINIMAX_MODEL"),
            "cerebras": _env("MARY_CEREBRAS_MODEL"),
            "together": _env("MARY_TOGETHER_MODEL"),
            "fireworks": _env("MARY_FIREWORKS_MODEL"),
            "openai_compatible": _env("MARY_OPENAI_COMPAT_MODEL"),
        },
        "conversation": {
