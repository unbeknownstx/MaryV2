...
def main() -> None:
    ...
    check(
        "shared-work recall uses durable user-grounded relationship history",
        shared_work.intent_type == IntentType.RELATIONSHIP_QUERY
        and shared_work.parameters.get("relationship_query_type") == "shared_work",
    )
