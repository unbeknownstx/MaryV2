...
class RuntimeEnvironment:
    ...
    def host_type(self) -> str:
        # Strong explicit host signals win over inherited ambient markers.
        # This keeps host simulations deterministic when, for example, a
        # Codespaces test itself runs inside Replit.
