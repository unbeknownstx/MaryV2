...
class ConversationLearningBridge:
    ...
    _INVITATION_PATTERNS: tuple[str, ...] = (
        ...
        r"\banything (?:u|you) want to ask(?: me)?\b",
        r"\bis there anything (?:u|you) (?:currently )?want to (?:learn|ask(?: me)?(?: about)?)\b",
        r"\bis there anything (?:u|you) (?:currently )?want to work on,? (?:learn|or learn),? or ask me about\b",
