...
class MaryEcosystem:
    ...
    def snapshot(self) -> dict[str, Any]:
        return {
            ...
            "external": {"twitch": twitch_policy_from_environment().to_dict(), "obs": obs_policy_from_environment().to_dict()},
    ...
    def record_turn(self, *, elapsed: float | None = None) -> None:
        if elapsed is not None: self.metrics.record("mary_turn", elapsed)
